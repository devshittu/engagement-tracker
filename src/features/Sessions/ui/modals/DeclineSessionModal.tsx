...
const DeclineSessionModal: React.FC<DeclineSessionModalProps> = ({
  ...
  useEffect(() => {
    logger.debug('DeclineSessionModal rendered', {
      sessionId,
      show,
      hasReasons: declineReasons.length,
    });
  ...
  const handleSubmit = () => {
    ...
    logger.info('Decline modal submitted', {
      sessionId,
      selectedReasonId,
      description,
    });
      ...
      <div className="p-6">
        ...
        <div className="form-control mb-4">
          ...
          <select
            ...
            onChange={(e) => {
              ...
              logger.debug('Decline reason selected', {
                sessionId,
                reasonId: value,
              });
        ...
        <div className="form-control mb-4">
          ...
          <textarea
            ...
            value={description}
            onChange={(e) => {
              logger.debug('Decline description updated', {
                sessionId,
